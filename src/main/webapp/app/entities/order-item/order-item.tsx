    ...
    return (
      <div>
        <h2 id="order-item-heading">
          <Translate contentKey="jpaMetaModelApp.orderItem.home.title">Order Items</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jpaMetaModelApp.orderItem.home.createLabel">Create new Order Item</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('quantity')}>
                  <Translate contentKey="jpaMetaModelApp.orderItem.quantity">Quantity</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('totalPrice')}>
                  <Translate contentKey="jpaMetaModelApp.orderItem.totalPrice">Total Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="jpaMetaModelApp.orderItem.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jpaMetaModelApp.orderItem.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jpaMetaModelApp.orderItem.order">Order</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {orderItemList.map((orderItem, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{orderItem.order ? <Link to={`productOrder/${orderItem.order.id}`}>{orderItem.order.code}</Link> : ''}</td>
