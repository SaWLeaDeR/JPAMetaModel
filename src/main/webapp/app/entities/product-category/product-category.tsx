    ...
    return (
      <div>
        <h2 id="product-category-heading">
          <Translate contentKey="jpaMetaModelApp.productCategory.home.title">Product Categories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jpaMetaModelApp.productCategory.home.createLabel">Create new Product Category</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jpaMetaModelApp.productCategory.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="jpaMetaModelApp.productCategory.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
