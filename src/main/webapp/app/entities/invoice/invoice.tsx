    ...
    return (
      <div>
        <h2 id="invoice-heading">
          <Translate contentKey="jpaMetaModelApp.invoice.home.title">Invoices</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jpaMetaModelApp.invoice.home.createLabel">Create new Invoice</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('date')}>
                  <Translate contentKey="jpaMetaModelApp.invoice.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('details')}>
                  <Translate contentKey="jpaMetaModelApp.invoice.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="jpaMetaModelApp.invoice.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('paymentMethod')}>
                  <Translate contentKey="jpaMetaModelApp.invoice.paymentMethod">Payment Method</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('paymentDate')}>
                  <Translate contentKey="jpaMetaModelApp.invoice.paymentDate">Payment Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('paymentAmount')}>
                  <Translate contentKey="jpaMetaModelApp.invoice.paymentAmount">Payment Amount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jpaMetaModelApp.invoice.order">Order</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {invoiceList.map((invoice, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{invoice.order ? <Link to={`productOrder/${invoice.order.id}`}>{invoice.order.code}</Link> : ''}</td>
