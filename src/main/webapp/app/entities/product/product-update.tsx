...
export class ProductUpdate extends React.Component<IProductUpdateProps, IProductUpdateState> {
  ...
  productCategoryUpdate = element => {
    ...
    if (name === '') {
      ...
      for (const i in this.props.productCategories) {
        if (name === this.props.productCategories[i].name.toString()) {
          this.setState({
            productCategoryId: this.props.productCategories[i].id
          });
        }
      }
    }
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jpaMetaModelApp.product.home.createOrEditLabel">
              <Translate contentKey="jpaMetaModelApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : productEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="jpaMetaModelApp.product.name">Name</Translate>
                  </Label>
                  <AvField
                    id="product-name"
                    type="text"
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="description">
                    <Translate contentKey="jpaMetaModelApp.product.description">Description</Translate>
                  </Label>
                  <AvField id="product-description" type="text" name="description" />
                </AvGroup>
                <AvGroup>
                  <Label id="priceLabel" for="price">
                    <Translate contentKey="jpaMetaModelApp.product.price">Price</Translate>
                  </Label>
                  <AvField
                    id="product-price"
                    type="text"
                ...
                <AvGroup>
                  <Label id="sizeLabel">
                    <Translate contentKey="jpaMetaModelApp.product.size">Size</Translate>
                  </Label>
                  <AvInput
                    id="product-size"
                    type="select"
                ...
                <AvGroup>
                  <AvGroup>
                    <Label id="imageLabel" for="image">
                      <Translate contentKey="jpaMetaModelApp.product.image">Image</Translate>
                    </Label>
                    <br />
                    {image ? (
                      <div>
                ...
                <AvGroup>
                  <Label for="productCategory.name">
                    <Translate contentKey="jpaMetaModelApp.product.productCategory">Product Category</Translate>
                  </Label>
                  <AvInput
                    ...
                    onChange={this.productCategoryUpdate}
                  >
                    <option value="" key="0" />
                    {productCategories
                  ...
                  <AvInput id="product-productCategory" type="hidden" name="productCategory.id" value={this.state.productCategoryId} />
                </AvGroup>
