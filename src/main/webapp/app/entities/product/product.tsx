    ...
    return (
      <div>
        <h2 id="product-heading">
          <Translate contentKey="jpaMetaModelApp.product.home.title">Products</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jpaMetaModelApp.product.home.createLabel">Create new Product</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="jpaMetaModelApp.product.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('description')}>
                  <Translate contentKey="jpaMetaModelApp.product.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('price')}>
                  <Translate contentKey="jpaMetaModelApp.product.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('size')}>
                  <Translate contentKey="jpaMetaModelApp.product.size">Size</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('image')}>
                  <Translate contentKey="jpaMetaModelApp.product.image">Image</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {product.productCategory ? (
                      <Link to={`productCategory/${product.productCategory.id}`}>{product.productCategory.name}</Link>
                    ) : (
                      ''
                    )}
                  </td>
